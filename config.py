...
def params_setup(cmdline=None):
  ...
  # training params
  parser.add_argument('--use_lstm', type=str, default=False, help='Set LSTM cells (True) or GRU cells (False)')
  ...
  parser.add_argument('--size', type=int, default=8, help='Size of each model layer.')
